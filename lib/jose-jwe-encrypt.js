...
export class Encrypter {
   ...
   */
  encrypt (plainText) {
    return this.encryptBinary(Utils.arrayFromUtf8String(plainText));
  }
  ...
  encryptBinary (plainTextArray) {
     ...
     * @return Promise<json>
     */
    var encryptPlainText = function (cekPromise, plainTextArray) {
      // Create header
      var headers = {};
      ...
      plainTextArray = Utils.arrayish(plainTextArray);
    ...
    var encPromise = encryptPlainText.bind(this, cekPromise, plainTextArray)();
